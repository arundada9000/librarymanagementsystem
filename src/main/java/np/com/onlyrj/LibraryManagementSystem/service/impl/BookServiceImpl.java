...
import np.com.onlyrj.LibraryManagementSystem.mapper.BookMapper;
...
import np.com.onlyrj.LibraryManagementSystem.repository.BookRepository;
...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<BookDTO> createBooksBulks(List<BookDTO> bookDTOS) throws BookException {
    ...
    @Override
    public void hardDelete(Long bookId) throws BookException {
        Book existingBook = bookRepository.findById(bookId).orElseThrow(
                ()-> new BookException("Book not found...")
        );
